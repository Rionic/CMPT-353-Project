...
businessdf = spark.read.csv('Data/all_reviews_cleaned.csv', header=True)
reviewsdf = spark.read.json('archive/yelp_academic_dataset_review.json/')
userdf = spark.read.json('archive/yelp_academic_dataset_user.json/')
...
joined.toPandas().to_csv('Data/business_reviews_users_merged.csv')
